import { observability, trackMessageSent, trackModelSwitch, trackError } from "../observability";
import type { ChatModelId } from "../validation";
...
import { captureAnalyticsEvent, identifyUser, resetUser } from "../analytics";
...
describe("observability", () => {
  beforeEach(() => {
    ...
    (observability as any).isInitialized = false;
    (observability as any).userId = null;
  });

  describe("initialization", () => {
    it("should initialize without user", () => {
      observability.initialize();
      expect((observability as any).isInitialized).toBe(true);
    });

    it("should initialize with user", () => {
      observability.initialize("user-123");
      expect((observability as any).isInitialized).toBe(true);
      expect((observability as any).userId).toBe("user-123");
  ...
  describe("user management", () => {
    ...
    it("should reset user", () => {
      ...
      expect((observability as any).userId).toBe(null);
