        ...
        <ThemeProvider>
          <QueryProvider>
            <div className="flex h-full flex-col">
              <header className="border-b border-border/60 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/70 flex-shrink-0">
              ...
              <main className="flex-1 min-h-0 overflow-hidden">
                <div className="mx-auto h-full w-full max-w-5xl px-5 py-8">{children}</div>
              </main>
              <footer className="border-t border-border/60 bg-background/80 py-4 flex-shrink-0">
